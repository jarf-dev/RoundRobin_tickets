...
INSERT INTO `zendesk`.`AlgoritmosDisponibles` (`nombreAlgoritmo`, `descripcionAlgoritmo`, `nombreArchivo`) VALUES ('Repartición en ronda', 'Reparte haciendo una ronda entre los usuarios asociados, no considera dificultad de la pregunta ni criterios de equidad', 'roundRobin_classic.py');
